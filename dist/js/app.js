...
var _parseDatarefs = require('../lib/parseDatarefs');

var _parseDatarefs2 = _interopRequireDefault(_parseDatarefs);
...
var App = function (_Component) {
  ...
  function App(props) {
    ...
    _this.loadDatarefs().then(function (datarefs) {
      _this.setState({
        loading: false,
        datarefs: (0, _parseDatarefs2.default)(datarefs)
      });
    }).catch(function (err) {
      _this.setState({
        loading: false,
  ...
  _createClass(App, [{
    key: 'loadDatarefs',
    value: function loadDatarefs() {
      return fetch('./DataRefs.txt').then(function (response) {
        if (response.ok) {
...
function datarefTable(app) {
  ...
  return (0, _preact.h)('table', {
  ...
  }, [(0, _preact.h)('thead', {}, [(0, _preact.h)('th', {
    ...
    className: 'mdl-data-table__cell--non-numeric'
  }, 'Writable'), (0, _preact.h)('th', {
    className: 'mdl-data-table__cell--non-numeric'
  }, 'Description')]), (0, _preact.h)('tbody', {}, app.state.datarefs.datarefs.filter(datarefFilter).map(datarefTableRow))]);
}
...
function datarefMatchesSearch(search, dataref) {
  return dataref.name.toLowerCase().search(search) !== -1 || (dataref.description || '').toLowerCase().search(search) !== -1;
}
...
function parseDatarefs(datarefs) {
  ...
  return {
    ...
    types: (0, _lodash.uniq)(datarefs.map((0, _lodash.property)('type'))),
    units: (0, _lodash.uniq)(datarefs.map((0, _lodash.property)('unit')))
  };
}
